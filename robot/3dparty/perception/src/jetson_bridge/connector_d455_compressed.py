...
rospy.init_node("jetson_connector_d455_color")

class debugger:
    def __init__(self):
        self.latestImage = None
        self.pub = rospy.Publisher("/d455/color/image_raw/compressed", CompressedImage, queue_size=1)
        self.subscriber = roslibpy.Topic(client, '/camera/color/image_raw/compressed', 'sensor_msgs/CompressedImage')
